...
const styles = StyleSheet.create({
  ...
  categoryTag: { ...Typography.caption, color: Colors.primary, fontWeight: '700', marginBottom: Spacing.sm },
  ...
  priceBlock: {
    ...
    backgroundColor: Colors.primaryLight, borderBottomWidth: 1, borderBottomColor: Colors.divider,
  },
  ...
  trustBadge: { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center' },
  ...
  acceptButtonText: { ...Typography.bodySmall, color: Colors.textInverse, fontWeight: '600' },
  ...
  statusChip: { paddingHorizontal: Spacing.md, paddingVertical: 4, borderRadius: BorderRadius.pill, borderWidth: 1.5 },
  statusChipText: { ...Typography.bodySmall, fontWeight: '700' },
